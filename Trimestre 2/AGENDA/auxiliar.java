...
class auxiliar extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent ae){
		...
		if(ae.getSource()==mostrar){
			...
			try{
				...
				while(rst.next()){
					fila[0]=rst.getString("Apellido");
					fila[1]=rst.getString("Nombre");
					fila[2]=rst.getString("Telefono");
					fila[3]=rst.getString("Mail");
					fila[4]=rst.getString("Fecha");
					modelo.addRow(fila);
					fil++;
				}
				rst.close();
